...
#ifndef _RASTER_TESTUTILS_H
#define _RASTER_TESTUTILS_H
...
/// @cond
#define _RASTER_TESTUTILS_IMPL
#include "Raster/impl/TestUtils.hpp"
#undef _RASTER_TESTUTILS_IMPL
/// @endcond

#endif // _RASTER_TESTUTILS_H
