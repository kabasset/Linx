...
#ifndef _KRASTER_VECTORARITHMETIC_H
#define _KRASTER_VECTORARITHMETIC_H
...
/// @cond INTERNAL
#define _KRASTER_VECTORARITHMETIC_IMPL
#include "KRaster/impl/VectorArithmetic.hpp"
#undef _KRASTER_VECTORARITHMETIC_IMPL
/// @endcond
